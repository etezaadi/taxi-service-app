...
<table class="table_dark">
    ...
    <tr><td><a href="${pageContext.request.contextPath}/cars/drivers">Display My Current Cars</a></td></tr>
    ...
    <tr><td><a href="${pageContext.request.contextPath}/cars/drivers/remove">Remove Driver from Car</a></td></tr>
</table>
</body>
</html>
